...
def get_movie_recommendations(username, top_n=5):
    ...
    # Use pivot_table to automatically average out any duplicate ratings
    matrix = df_ratings.pivot_table(index='username', columns='movie_id', values='rating', aggfunc='mean')
